function [ NUM,MESH] = Compute_Viscosity(i,NUM,j,MESH,CHAR,PAR,B)
...
if isfield(NUM.Viscosity,'mu_2d')
    ...
    NUM.Viscosity.mu_vis_2d     = zeros(NUM.NUMERICS.no_intp,NUM.NUMERICS.no_elems_global)   ;
end
...
% % For the Anton_benchmark runs uncomment this
% %%%REMOVE THIS%%%  % set the sides to be not plastic
% X = MESH.GCOORD(1,:);
