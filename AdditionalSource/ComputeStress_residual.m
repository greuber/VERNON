...
if isfield(NUM.Viscosity,'mu_2d')
    ...
    NUM.Stress.Tau_yield_2d     = zeros(NUM.NUMERICS.no_intp,NUM.NUMERICS.no_elems_global)   ;
end
...
if NUM.Plasticity.Plasticity
    ...
    if NUM.Solve.number_pic == 1    % in the first iteration in the first timestep pressure is set to 1
